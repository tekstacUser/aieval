...
# ============================================================
# GPU Dynamic Resource Allocation (DRA), Scheduling, Quota and Capacity Optimization Lab
#
# FINAL EVALUATOR
#
...
# AI failure output
#
# Always preserve the 3 GPU Dynamic Resource Allocation (DRA), Scheduling, Quota and Capacity Optimization Lab testcases /30.
# ============================================================
            ...
            expertise: {
                ...
                testcases: {
                    testcase: [
                        {
                            visible: "yes",
                            name: "Requirement Understanding of DRA Architecture and Resource Flow",
                            description:
                            ...
                            shortdescription:
                                "Requirement Understanding of DRA Architecture and Resource Flow could not be evaluated.",
                            maxmark: "10",
                            score: "0",
                            status: "fail",
                            failmessage: $reason
                        ...
                        {
                            visible: "yes",
                            name: "Prompt Quality for Manifest Authoring and Troubleshooting",
                            description:
                                ("Observed Evidence: No valid AI evaluation was produced.\nReason for Score: " + $reason + "\nMissing Evidence: Valid learner prompt-history evaluation."),
                            shortdescription:
                                "Prompt Quality for Manifest Authoring and Troubleshooting could not be evaluated.",
                            maxmark: "10",
                            score: "0",
                            status: "fail",
                            failmessage: $reason
                        ...
                        {
                            visible: "yes",
                            name: "Quota Enforcement and Capacity Optimization Reasoning",
                            description:
                                ("Observed Evidence: No valid AI evaluation was produced.\nReason for Score: " + $reason + "\nMissing Evidence: Valid learner prompt-history evaluation."),
                            shortdescription:
                                "Quota Enforcement and Capacity Optimization Reasoning could not be evaluated.",
                            maxmark: "10",
                            score: "0",
                            status: "fail",
                            failmessage: $reason
...
============================================================
GPU DYNAMIC RESOURCE ALLOCATION (DRA), SCHEDULING, QUOTA AND CAPACITY OPTIMIZATION LAB TESTCASES
============================================================

Requirement Understanding of DRA Architecture and Resource Flow = 10
Prompt Quality for Manifest Authoring and Troubleshooting = 10
Quota Enforcement and Capacity Optimization Reasoning = 10
...
============================================================
GPU DYNAMIC RESOURCE ALLOCATION (DRA), SCHEDULING, QUOTA AND CAPACITY OPTIMIZATION LAB RUBRIC
============================================================
...
Evaluate the learner prompt history for GPU Dynamic Resource Allocation (DRA), Scheduling, Quota and Capacity Optimization Lab.
    ...
    if [ "$HTTP_CODE" != "200" ]; then
        ...
        if [ -z "$AI_CONTENT" ]; then
            ...
            # ------------------------------------------------
                ...
                EXPECTED_NAMES='[
                    "Requirement Understanding of DRA Architecture and Resource Flow",
                    "Prompt Quality for Manifest Authoring and Troubleshooting",
                    "Quota Enforcement and Capacity Optimization Reasoning"
                ]'
                ...
                if ! printf '%s\n' "$CLEAN_CONTENT" |
                    ...
                    ai_failure \
                        "AI testcase names do not match the GPU Dynamic Resource Allocation (DRA), Scheduling, Quota and Capacity Optimization Lab rubric."
...
# ============================================================
# STANDARD TECHNICAL EVALUATION - 100 MARKS
#
# IMPORTANT:
# We are still inside:
#
#   /opt/Test/gbu-dra-lab
#
